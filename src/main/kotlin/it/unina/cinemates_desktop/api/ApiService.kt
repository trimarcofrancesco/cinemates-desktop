...
interface ApiService {
    ...
    @Headers("Content-Type: application/json")
    suspend fun removeReports(@Path("userId") userId: String, @Header("Authorization") authorization: String, @Body data: DeleteData): ApiResponse<Int>

    @DELETE("users/{userId}/reviews")
    @Headers("Content-Type: application/json")
    suspend fun removeInappropriateItem(@Path("userId") userId: String, @Header("Authorization") authorization: String, @Body data: DeleteData): ApiResponse<Int>
